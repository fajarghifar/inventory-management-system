...
final class FinanceTransactionTable extends PowerGridComponent
{
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('external_reference', fn(FinanceTransaction $model) => $model->external_reference ?: '-')
            ...
            ->add('amount_formatted', fn(FinanceTransaction $model) => 'Rp ' . number_format($model->amount, 0, ',', '.'))
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('External Ref', 'external_reference')
                ->sortable()
                ->searchable(),
