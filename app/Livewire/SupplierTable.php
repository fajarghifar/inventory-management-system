    ...
    public function actions(Supplier $row): array
    {
        return [
             Button::add('view')
                ...
                ->route('suppliers.show', ['supplier' => $row->id])
            ...
            Button::add('delete')
                ...
                ->attributes(['wire:confirm' => 'Are you sure you want to delete this supplier?'])
                ->tooltip('Delete Supplier'),
        ];
    }

    #[\Livewire\Attributes\On('delete')]
    public function delete($rowId, \App\Services\SupplierService $supplierService): void
    {
        ...
        if ($supplier) {
            try {
                ...
                $this->dispatch('toast', message: 'Failed to delete supplier: ' . $e->getMessage(), type: 'error');
            }
        }
    }
}
