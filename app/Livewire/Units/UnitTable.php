...
final class UnitTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('unit_export_' . now()->format('Y_m_d'))
    ...
    public function actions(Unit $row): array
    {
        return [
            ...
            Button::add('delete')
                ...
                ->attributes(['wire:confirm' => 'Are you sure you want to delete this unit?'])
                ->tooltip('Delete Unit'),
        ];
    }
    ...
    public function delete($rowId, UnitService $service): void
    {
        ...
        if ($unit) {
            try {
                ...
                $this->dispatch('toast', message: 'Failed to delete unit: ' . $e->getMessage(), type: 'error');
            }
        }
    }
}
